...
async function testPagination() {
	...
	try {
		...
		console.log(`📄 Page: ${data1.data.pagination.currentPage}/${data1.data.pagination.totalPages}`);
		console.log(`📊 Count: ${data1.data.jobRoles.length} items (Total: ${data1.data.pagination.totalCount})`);
		console.log(`🔄 Has Next: ${data1.data.pagination.hasNext}, Has Previous: ${data1.data.pagination.hasPrevious}\n`);
	} catch (error) {
	...
	try {
		...
		console.log(`📄 Page: ${data2.data.pagination.currentPage}/${data2.data.pagination.totalPages}`);
		console.log(`📊 Count: ${data2.data.jobRoles.length} items (Total: ${data2.data.pagination.totalCount})`);
		console.log(`🔄 Has Next: ${data2.data.pagination.hasNext}, Has Previous: ${data2.data.pagination.hasPrevious}\n`);
	} catch (error) {
		console.log(`❌ Error: ${error}\n`);
	}
	...
	try {
		...
		console.log(`📄 Page: ${data3.data.pagination.currentPage}/${data3.data.pagination.totalPages}`);
		console.log(`📊 Count: ${data3.data.jobRoles.length} items (Total: ${data3.data.pagination.totalCount})`);
		console.log(`🔄 Has Next: ${data3.data.pagination.hasNext}, Has Previous: ${data3.data.pagination.hasPrevious}\n`);
	} catch (error) {
		console.log(`❌ Error: ${error}\n`);
	}
	...
	try {
		...
		console.log(`📄 Page: ${data4.data.pagination.currentPage}/${data4.data.pagination.totalPages}`);
		console.log(`📊 Count: ${data4.data.jobRoles.length} items (Total: ${data4.data.pagination.totalCount})`);
		console.log(`🔄 Has Next: ${data4.data.pagination.hasNext}, Has Previous: ${data4.data.pagination.hasPrevious}\n`);
	} catch (error) {
		console.log(`❌ Error: ${error}\n`);
	}
